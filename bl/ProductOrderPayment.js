...
const updateOrderMsgByPrice = (params,callback)=>{
    ...
    const getSaledQuantity = (commodityInfo)=>{
        return new Promise((resolve, reject) => {
            productPaymentDAO.getCommodityPaymentStatus({productOrderId:params.productOrderId,type:sysConst.PRODUCT_PAYMENT.type.payment,status:sysConst.PRODUCT_PAYMENT.status.paid},(error,rows)=>{
                if(error){
