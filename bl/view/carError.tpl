...
<body style="margin: 30px 10%">
    ...
    <!--404-->
    <div class="center border2 mb2" style="width:80%;margin: 0 auto;">
        <h5 class="redColor bold fz25 padding_2">- 404 -</h5>
    </div>
    ...
    <div  class="center" >
        <div class="mb2">
            <img style="width: 60%;" {{mp_url}} />
        </div>
        <h6  class="bold mb1 fz10">{{long_press}}</h6>
        <p  class="bold mb1">{{more_information}}</p>
