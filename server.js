...
const createServer=()=>{
    ...
    server.put({path:'/api/user/:userId/userAddress/:addressId/type/:type/',contentType: 'application/json'},userAddress.updateStatus);
    ...
    server.put({path:'/api/admin/:adminId/order/:orderId/payment/:paymentId/paymentReview',contentType: 'application/json'},payment.updateTotalFee);
    /**
     * refund_apply
     */
