...
const createServer=()=>{
    ...
    server.get('/api/admin/:adminId/requireTask/:requireId/getSyncLoadTask',loadTask.getSyncLoadTask);
    ...
    server.get('/api/admin/:adminId/loadTask/:syncLoadTaskId/getSyncLoadTaskDetail',loadTaskDetail.getLoadTaskDetail);
