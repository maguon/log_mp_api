...
const createServer=()=>{
     ...
     * commodity
     */
    server.get('/api/commodity/:commodityId/poster/:posterId/view',commodity.getCommodityPage);
    ...
    server.put({path:'/api/admin/:adminId/commodity/:commodityId/prodImages',contentType: 'application/json'},commodity.updateProdImages);
     ...
     * product_order_info
     */
    server.get('/api/user/:userId/productOrder/:productOrderId/paymentStatus' ,productOrder.getPaymentStatus);
    ...
    server.post({path:'/api/admin/:adminId/productOrder/:productOrderId/productPayment/:productPaymentId/wechatRefund',contentType: 'application/json'},productOrderPayment.updateRefundStatus);
