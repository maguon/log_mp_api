...
const addOrderCar = (params,callback) => {
    let query = " insert into order_item(user_id,order_id,vin,model_type,old_car,valuation,act_trans_price,act_insure_price) values(?,?,?,?,?,?,?,?) ";
    let paramsArray = [],i=0;
...
const addOrderCarAdmin = (params,callback) => {
    let query = " insert into order_item(safe_status,user_id,order_id,vin,model_type,old_car,valuation,type,act_trans_price,act_insure_price) values(?,?,?,?,?,?,?,1,?,?) ";
    let paramsArray = [],i=0;
